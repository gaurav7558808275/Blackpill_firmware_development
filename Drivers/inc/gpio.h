...
// INPUT INTERRUPT MODE, comes under mode register
...
//GPIO AVAILABLE OUTPUT MODES comes under mode register
#define GPIO_MODE_OUT_PP	0			// OUTPUT PUHSPULL MODE
#define GPIO_MODE_OUT_OD	1			// OUTPUT OPEN DRAIN MODE
//GPIO AVAILABLE SPEED comes under speed register
#define GPIO_SPEED_LOW		0
#define GPIO_SPEED_MED		1
#define GPIO_SPEED_FAST		2
#define GPIO_SPEED_HIGH		3
//GPIO PORT PUSH PULL MACROS comes under pull up and pull down register
...
#define GPIO_ALT_MODE_0		0  	//AF0
#define GPIO_ALT_MODE_1		1	//AF1
#define GPIO_ALT_MODE_2		2	//AF2
#define GPIO_ALT_MODE_3		3	//AF3
#define GPIO_ALT_MODE_4		4	//AF4
#define GPIO_ALT_MODE_5		5	//AF5
#define GPIO_ALT_MODE_6		6	//AF6
#define GPIO_ALT_MODE_7		7	//AF7
#define GPIO_ALT_MODE_8		8	//AF8
#define GPIO_ALT_MODE_9		9	//AF9
#define GPIO_ALT_MODE_10	10	//AF10
#define GPIO_ALT_MODE_11	11	//AF11
#define GPIO_ALT_MODE_12	12	//AF12
#define GPIO_ALT_MODE_13	13	//AF13
#define GPIO_ALT_MODE_14	14	//AF14
#define GPIO_ALT_MODE_15	15	//AF15
